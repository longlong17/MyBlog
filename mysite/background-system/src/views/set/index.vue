...
export default {
  ...
  methods: {
    fetchData() {
      getSetting().then(res=>{
       const noData = {
        avatar: "https://img0.baidu.com/it/u=217435033,511611465&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1662742800&t=094a4edb6b9da176805fb54256a88acb",
        favicon: "无数据",
        github: "无数据",
        githubName: "https://img0.baidu.com/it/u=217435033,511611465&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1662742800&t=094a4edb6b9da176805fb54256a88acb",
        icp: "无数据",
        id: "无数据",
        mail: "无数据",
        qq: "无数据",
        qqQrCode: "https://img0.baidu.com/it/u=217435033,511611465&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1662742800&t=094a4edb6b9da176805fb54256a88acb",
        siteTitle: "无数据",
        weixin: "无数据",
        weixinQrCode: "https://img0.baidu.com/it/u=217435033,511611465&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1662742800&t=094a4edb6b9da176805fb54256a88acb",
      };
      if (res.data) {
        //说明有数据
         this.form = res.data;
    ...
    confirmEditSetting(){
      setSetting(this.form2).then((resp)=>{
